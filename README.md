# Pré-reserva
Aplicação para gerencimento de pré-reservas de salas informatizadas da SCINFOR-EESC.

## Motivação
Na SCINFOR-EESC, existem três salas informatizadas disponíveis para reserva, que também podem ser solicitadas por servidores e docentes de outras unidades do campus. Devido às características específicas de cada uma dessas salas, é necessário que a sala de cada reserva seja definida por um gerente. Por esse motivo, não é possível estender as reservas dessas salas através do sistema de Reserva de Espaços para os interessados.
